	...
	_createClass(ReactCodeMirror, [{
		...
		value: function componentDidMount() {
			...
			this.codeMirror.on('change', function (doc, change) {
				return _this2.codemirrorValueChanged(doc, change);
			});
			this.codeMirror.on('focus', function (e) {
				return _this2.focusChanged.bind(true);
			});
			this.codeMirror.on('blur', function (e) {
				return _this2.focusChanged(false);
			});
